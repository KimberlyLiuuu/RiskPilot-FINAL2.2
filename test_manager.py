...
safety_result = safety_agent.analyze(text)

print("📅 正在进行工期分析...")
schedule_agent = ScheduleAgent()
schedule_result = schedule_agent.analyze(text)

print("🏗️ 正在进行质量分析...")
quality_agent = QualityAgent()
quality_result = quality_agent.analyze(text)

print("🤖 正在进行综合风险分析...")
manager_agent = ManagerAgent()

final_result = manager_agent.analyze(
    safety_result,
    schedule_result,
    quality_result
)
