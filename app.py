...
For Worker reports:
- Keep every field extremely concise.
- The opening MUST start with HIGH RISK, MEDIUM RISK or LOW RISK.
- The opening must immediately tell workers what to watch for.

For Manager reports:
- Be analytical and operational.

For Client reports:
- Be transparent and sincere.
- Explain the situation without alarming language.
- End with a reassuring but truthful statement about resolving issues
  and reporting project progress honestly.
"""
